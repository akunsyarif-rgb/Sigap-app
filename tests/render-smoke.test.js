...
const cases = [
  ...
  ['KelolaTab (Jadwal Piket, hasil cari guru terbuka)', { teachers: [teacher], students: [student], jadwalPiket: jadwal, onAddTeacher: () => {}, onUpdatePassword: () => {}, onUpdateJabatan: () => {}, onToggleStatus: () => {}, onUpdateRole: () => {}, onUpdateWaliKelas: () => {}, onUpdateName: () => {}, onDeleteTeacher: () => {}, onSetJadwalPiket: () => {}, onDeleteSurat: () => {}, loading: false }, 'KelolaTab', ['jadwal', undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, 'Kar']],
  // idx 26 = confirmAddGuru -- dialog konfirmasi tambah guru piket terbuka.
  ['KelolaTab (konfirmasi tambah guru piket terbuka)', { teachers: [teacher], students: [student], jadwalPiket: jadwal, onAddTeacher: () => {}, onUpdatePassword: () => {}, onUpdateJabatan: () => {}, onToggleStatus: () => {}, onUpdateRole: () => {}, onUpdateWaliKelas: () => {}, onUpdateName: () => {}, onDeleteTeacher: () => {}, onSetJadwalPiket: () => {}, onDeleteSurat: () => {}, loading: false }, 'KelolaTab', ['jadwal', undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, { id: 'G01', name: 'Kartina', hari: 'Senin' }]],
  ...
  // tujuan, jalurKhusus, alasanKhusus, saving, msg, msgTone, busyId.
  ['IzinKeluarPanel (petugas berwenang)', { students: [student], izinList: izinSemua, canVerify: true, waliKelasMap, ...izinHandlers }, 'IzinKeluarPanel'],
