...
const cases = [
  ...
  ['KelolaTab', { teachers: [teacher], students: [student], jadwalPiket: jadwal, onAddTeacher: () => {}, onUpdatePassword: () => {}, onUpdateJabatan: () => {}, onToggleStatus: () => {}, onUpdateRole: () => {}, onUpdateWaliKelas: () => {}, onSetJadwalPiket: () => {}, onDeleteSurat: () => {}, loading: false }],
  ['KelolaTab (view: Kelola Guru)', { teachers: [teacher], students: [student], jadwalPiket: jadwal, onAddTeacher: () => {}, onUpdatePassword: () => {}, onUpdateJabatan: () => {}, onToggleStatus: () => {}, onUpdateRole: () => {}, onUpdateWaliKelas: () => {}, onSetJadwalPiket: () => {}, onDeleteSurat: () => {}, loading: false }, 'KelolaTab', ['guru']],
  ['KelolaTab (view: Jadwal Piket)', { teachers: [teacher], students: [student], jadwalPiket: jadwal, onAddTeacher: () => {}, onUpdatePassword: () => {}, onUpdateJabatan: () => {}, onToggleStatus: () => {}, onUpdateRole: () => {}, onUpdateWaliKelas: () => {}, onSetJadwalPiket: () => {}, onDeleteSurat: () => {}, loading: false }, 'KelolaTab', ['jadwal']],
  ['KelolaTab (view: Pemeliharaan Data)', { teachers: [teacher], students: [student], jadwalPiket: jadwal, onAddTeacher: () => {}, onUpdatePassword: () => {}, onUpdateJabatan: () => {}, onToggleStatus: () => {}, onUpdateRole: () => {}, onUpdateWaliKelas: () => {}, onSetJadwalPiket: () => {}, onDeleteSurat: () => {}, loading: false }, 'KelolaTab', ['surat']],
  ['KelolaTab (bottom sheet Tambah Guru terbuka)', { teachers: [teacher], students: [student], jadwalPiket: jadwal, onAddTeacher: () => {}, onUpdatePassword: () => {}, onUpdateJabatan: () => {}, onToggleStatus: () => {}, onUpdateRole: () => {}, onUpdateWaliKelas: () => {}, onSetJadwalPiket: () => {}, onDeleteSurat: () => {}, loading: false }, 'KelolaTab', ['guru', true]],
  ['KelolaTab (modal reset password terbuka)', { teachers: [teacher], students: [student], jadwalPiket: jadwal, onAddTeacher: () => {}, onUpdatePassword: () => {}, onUpdateJabatan: () => {}, onToggleStatus: () => {}, onUpdateRole: () => {}, onUpdateWaliKelas: () => {}, onSetJadwalPiket: () => {}, onDeleteSurat: () => {}, loading: false }, 'KelolaTab', ['guru', undefined, undefined, undefined, undefined, undefined, undefined, teacher]],
