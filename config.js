...
// Dimuat PALING AWAL karena file lain semua bergantung ke sini.
       ...
       const ROLES = {
           admin:         { label: 'Admin',         menus: ['scan', 'dashboard', 'log', 'stats', 'pelanggaran', 'bimbingan', 'upacara', 'auditlog', 'kelola'], primaryMenus: ['scan', 'dashboard', 'log', 'pelanggaran'], canExport: true },
           bk_kesiswaan:  { label: 'BK/Kesiswaan',  menus: ['scan', 'dashboard', 'log', 'stats', 'pelanggaran', 'bimbingan', 'upacara', 'auditlog'],          primaryMenus: ['scan', 'dashboard', 'log', 'pelanggaran'], canExport: false },
           guru:          { label: 'Guru',          menus: ['scan', 'dashboard', 'log', 'stats', 'pelanggaran'],                                    primaryMenus: ['scan', 'dashboard', 'log', 'pelanggaran'], canExport: false },
           osis:          { label: 'OSIS',          menus: ['upacara'],                                                                             primaryMenus: ['upacara'], canExport: false },
       };
